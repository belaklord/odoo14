...
class WebsiteSalePayment(WebsiteSale):
    ...
    def payment(self, **post):
        ...
        for envio in order.order_line:
            if not envio.product_id.name == 'Envío' and not envio.product_id.x_marca_id.display_name == 'NAJLO' and not envio.product_id.x_marca_id.display_name == 'CKR' and not envio.product_id.x_marca_id.display_name == 'ESTHESIA':
    ...
    def puntos(self, puntos, **post):
        ...
        if puntos and int(puntos) < puntos_usuario and ficha_usuarios.x_puntosRestantes == 0:
        ...
        elif puntos and int(puntos) > puntos_usados:
